...
def myfunction(**context):
    print(int(context["ti"].xcom_pull(task_ids='tarea_2')) + 24) # Deberiamos ver 48

with DAG(dag_id="12-XCom",
    ...
    t2 = BashOperator(task_id="tarea_2",
                    ...
                    # ti: task instance y con xcom_pull traemos el resultado de otra tarea
